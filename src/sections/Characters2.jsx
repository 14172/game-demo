...
function Characters2() {
  ...
  return (
    <section className="min-h-screen bg-gradient-to-b from-purple-900 via-slate-950 to-black text-white pt-[140px] px-6 pb-20">
      <div className="max-w-6xl mx-auto">
        {/* 返回按鈕 */}
        <button
          onClick={() => navigate("/")}
          className="mb-10 text-purple-400 hover:text-white transition"
        >
          ← 返回名錄
        </button>
